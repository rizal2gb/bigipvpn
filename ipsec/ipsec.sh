...
wget -O /usr/bin/addl2tp https://${bigipvpn}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${bigipvpn}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${bigipvpn}/addpptp.sh && chmod +x /usr/bin/addpptp
