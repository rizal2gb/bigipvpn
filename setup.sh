...
echo "   - Stunnel4                : 445, 990, 222, 777"  | tee -a log-install.txt
echo "   - Dropbear                : 109, 69, 77"  | tee -a log-install.txt
echo "   - CDN Dropbear            : 8880"  | tee -a log-install.txt
echo "   - CDN TLS                 : 443"  | tee -a log-install.txt
echo "   - CDN Ovpn                : 2086"  | tee -a log-install.txt
...
echo "   - Whatsapp                : 6283857684916"  | tee -a log-install.txt
