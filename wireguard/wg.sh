...
echo -e "${Info} Wireguard Script By AnonPhreaker"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://${bigipvpn}/addwg.sh"
wget -O delwg "https://${bigipvpn}/delwg.sh"
wget -O renewwg "https://${bigipvpn}/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
