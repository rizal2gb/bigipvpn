#!/bin/bash
#shadowsocks-libev obfs install by AnonPhreaker
# Feel free to use
# ==========================================
# Color
RED='\033[0;31m'
...
cd /usr/bin
wget -O addss "https://${bigipvpn}/addss.sh"
wget -O delss "https://${bigipvpn}/delss.sh"
wget -O cekss "https://${bigipvpn}/cekss.sh"
wget -O renewss "https://${bigipvpn}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
